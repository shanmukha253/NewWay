...
<TABLE style=" border: 1px solid black;
  ...
  border-collapse: collapse;">S.No</TH>
      <TH style=" border: 1px solid black;
  border-collapse: collapse;">First Name</TH>
      <TH style=" border: 1px solid black;
  border-collapse: collapse;">Second Name</TH>
      <TH style=" border: 1px solid black;
  border-collapse: collapse;">Date of Birth</TH>
      <TH style=" border: 1px solid black;
  border-collapse: collapse;">Gender</TH>
      <TH style=" border: 1px solid black;
  border-collapse: collapse;">Email</TH>
  <TH style=" border: 1px solid black;
  border-collapse: collapse;">Mobile</TH>
  <TH style=" border: 1px solid black;
  border-collapse: collapse;">Aadhar No</TH>
  <TH style=" border: 1px solid black;
  border-collapse: collapse;">User Name</TH>
  <TH style=" border: 1px solid black;
  border-collapse: collapse;">Password</TH>
  <TH style=" border: 1px solid black;
  border-collapse: collapse;">Date of Register</TH>
  ...
  border-collapse: collapse;"> <%= rs.getString(7) %></TD>
        <TD style=" border: 1px solid black;
  border-collapse: collapse;"> <%= rs.getString(8) %></td>
       <TD style=" border: 1px solid black;
  border-collapse: collapse;"> <%= rs.getString(9) %></TD>
        <TD style=" border: 1px solid black;
  border-collapse: collapse;"> <%= rs.getString(10) %></td>
       <TD style=" border: 1px solid black;
  border-collapse: collapse;"> <%= rs.getString(11) %></TD>
       
      </TR>
      <% } %>
     </TABLE>
     <h1>
     Click Here for journey details
     <a href="Dbdestination.jsp"><button>Open</button></a> </h1></center>
</body>
</html>