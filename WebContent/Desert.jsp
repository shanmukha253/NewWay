...
<center>
<h1 style="color:red;font-size:50px;">Please login to know who are planing to visit these places<br>
</h1><h2>Click here to login</h2><a href="Index.jsp"><button>Login In</button></a>
